...
<div style="padding: 10px" class="admin-content">
    ...
    <%return;
     ...
     HashMap mmm = new CommDAO().getmaps("gonghao", (String) request.getSession().getAttribute("username"), "yuangong");
                ...
                <form action="yuangong.jsp?a=update" method="post" name="form1" id="form1">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_bumen7"
                                    ...
                                    style="width: 250px"
                                >
                                    <% List<Map> select = new CommDAO().select("SELECT * FROM bumen where id='"+session.getAttribute("bumen")+"' ORDER BY id desc"); %>
 <% for (Map m : select) { %>
                                ...
                                <script>
                                    $(".class_bumen7").val($(".class_bumen7").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_zhiwei8"
                                    ...
                                    style="width: 250px"
                                >
                                    <% select = new CommDAO().select("SELECT * FROM zhiwei where id='"+session.getAttribute("zhiwei")+"' ORDER BY id desc"); %>
 <% for (Map m : select) { %>
                                ...
                                <script>
                                    $(".class_zhiwei8").val($(".class_zhiwei8").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
