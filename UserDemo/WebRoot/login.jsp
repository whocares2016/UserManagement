...
<div class="login layui-anim layui-anim-up">
    <div class="message">公司用户管理系统-管理登录</div>
    ...
    <form method="post" class="layui-form" action="login?ac=adminlogin&a=a">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <img alt="刷新验证码" onClick="this.src='image.jsp?time='+new Date().getTime();" src="image.jsp"
                     style="cursor: pointer; padding-top: 10px"/>
            </div>
        </div>
        <hr class="hr15"/>
        <input value="登录" lay-submit lay-filter="login" style="width: 100%" type="submit"/>
        <a href="yuangong_add1.jsp">员工注册</a>
        <hr class="hr20"/>
    </form>
</div>
