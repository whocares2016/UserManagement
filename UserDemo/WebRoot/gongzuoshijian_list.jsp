...
<div style="padding: 10px" class="admin-content">
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select-update" data-value="<%= request.getParameter("bumen") !=null ? request.getParameter("bumen") : "" %>" id="bumen" name="bumen">
 ...
 <% for (Map m : select) { %>
                        ...
                        <script>
                            $(".class_bumen12 select-update").val($(".class_bumen12 select-update").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        职位

                        <select class="form-control select-update" data-value="<%= request.getParameter("zhiwei") !=null ? request.getParameter("zhiwei") : "" %>" id="zhiwei" name="zhiwei">
                            <option value="">请选择</option>
 ...
 <% for (Map m : select) { %>
                        ...
                        <script>
                            $(".class_zhiwei13 select-update").val($(".class_zhiwei13 select-update").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        工作日期
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapbumen7 = new CommDAO().find("SELECT bumenmingcheng FROM bumen where id='" + map.get("bumen") + "'"); %>
<%= mapbumen7.get("bumenmingcheng") %></td>
                            <td><% Map mapzhiwei8 = new CommDAO().find("SELECT zhiweimingcheng FROM zhiwei where id='" + map.get("zhiwei") + "'"); %>
<%= mapzhiwei8.get("zhiweimingcheng") %></td>
                            ...
                            <td align="center">
                                ...
                                <a href="gongzuoshijian_updt.jsp?id=<%= map.get("id") %>">编辑</a>

                                <a href="gongzuoshijian.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        <%} %>
